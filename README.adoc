...
NOTE: If you are looking for macOS help, that is the place -> https://github.com/seathasky/MnM-on-Mac
...
* Windows build compatible with Proton 10+ (e.g Steam, UMU, PROTON-GE + Lutris).
