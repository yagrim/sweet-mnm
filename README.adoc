...
. Setup "sweet.exe" in you preferred Proton environment. For example using Steam "Add a Non-Steam Game...", or Lutris or UMU.
...
WARNING: This is WIP project, there's not yet a release pipeline, so for now, you can get the packages from the `main` branch builds https://github.com/yagrim/sweet-mnm/actions.
...
Run `sweet --help` to find the extra options.
