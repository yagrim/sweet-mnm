...
class CredentialsPanelTest {
    ...
    void shouldRestoreStoredCredentials() {
        CredentialsPanel credentialsPanel = new CredentialsPanel(new CredentialsHandler(new InMemorySettingsStore(Map.of(
            ...
            InMemorySettingsStore.PASSWORD_KEY, "secret"))), settingsStore);
    ...
    void shouldRestoreStoreCredentialsOption() {
        ...
        CredentialsPanel credentialsPanel = new CredentialsPanel(new CredentialsHandler(settings), settingsStore);
    ...
    void shouldLeaveCredentialsEmptyWhenNotStored() {
        CredentialsPanel credentialsPanel = new CredentialsPanel(new CredentialsHandler(new InMemorySettingsStore(Map.of())), settingsStore);
